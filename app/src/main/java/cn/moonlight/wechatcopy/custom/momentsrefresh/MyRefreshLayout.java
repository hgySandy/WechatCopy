...
public class MyRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    /**
     * Simple constructor to use when creating a MyRefreshLayout from code.
     *
     * @param context
     */
    ...
    /**
     * Constructor that is called when inflating MyRefreshLayout from XML.
     *
     * @param context
     * @param attrs
     */
...
//        mScaleDownAnimation.setDuration(SCALE_DOWN_DURATION);
    ...
    public void setProgressView(MaterialProgressDrawable progress){
...
//                (width / 2 + circleWidth / 2), mCurrentTargetOffsetTop + circleHeight);
        mCircleView.layout(childLeft + 50, mCurrentTargetOffsetTop,
                childLeft + circleWidth + 50, mCurrentTargetOffsetTop + circleHeight);
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                final float y = ev.getY(pointerIndex);
                // 记录手指移动的距离，mInitialMotionY是初始的位置，DRAG_RATE是拖拽因子，默认位0.5
